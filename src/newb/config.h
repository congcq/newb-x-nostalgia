...
#define NL_GAMMA 1.22                  // 0.3 low ~ 2.0 high
#define NL_EXPOSURE 1.0              // [toggle] 0.5 dark ~ 3.0 bright
#define NL_SATURATION 1.13            // [toggle] 0.0 grayscale ~ 4.0 super saturated
...
#define NL_TORCH_INTENSITY 1.9  // 0.5 weak ~ 3.0 bright
...
#define NL_MORNING_SUN_COL vec3(0.8,0.4,0.0)
#define NL_NOON_SUN_COL    vec3(0.99,0.98,0.97)
#define NL_NIGHT_SUN_COL   vec3(0.18,0.39,0.7)

/* Ambient light on terrain (light that is added everywhere) */
#define NL_NETHER_AMBIENT vec3(1.2,0.5,0.55)*1.3
...
#define NL_DAY_ZENITH_COL    vec3(0.15,0.32,0.65)*1.5
#define NL_DAY_HORIZON_COL   vec3(1.5,1.5,1.6)*1.5
#define NL_NIGHT_ZENITH_COL  vec3(0.0,0.085,0.24)*0.9
#define NL_NIGHT_HORIZON_COL vec3(0.02,0.31,0.6)*3.3
#define NL_RAIN_ZENITH_COL   vec3(0.5,0.51,0.51)
#define NL_RAIN_HORIZON_COL  vec3(1.4,1.5,1.5)
#define NL_END_ZENITH_COL    vec3(0.18,0.02,0.18)
#define NL_END_HORIZON_COL   vec3(0.99,0.7,0.75)
#define NL_DAWN_ZENITH_COL   vec3(0.3,0.38,0.65)*0.7
#define NL_DAWN_HORIZON_COL  vec3(2.6, 0.5, 0.0)*1.5
...
#define NL_WATER_WAVE_SPEED  1.2  // 0.2 calm ~ 2.0 turbulent
...
/* Underwater */
#define NL_UNDERWATER_BRIGHTNESS 1.9         // 0.0 dark ~ 3.0 bright
...
#define NL_CLOUD0_THICKNESS 2.7      // 0.5 slim ~ 8.0 fat
...
#define NL_CLOUD2_THICKNESS 4.9            // 0.5 slim ~ 5.0 fat
#define NL_CLOUD2_RAIN_THICKNESS 5.4       // 0.5 slim ~ 5.0 fat
#define NL_CLOUD2_STEPS 9                  // 3 low quality ~ 16 high quality
#define NL_CLOUD2_SCALE vec2(0.0143, 0.0143) // 0.003 large ~ 0.3 tiny
...
#define NL_CLOUD2_LAYER2_OFFSET 232.0           // 30.0 near ~ 300.0 very high
#define NL_CLOUD2_LAYER2_THICKNESS 4.2          // 0.7 slim ~ 5.0 fat
#define NL_CLOUD2_LAYER2_RAIN_THICKNESS 4.6     // 0.7 slim ~ 5.0 fat
#define NL_CLOUD2_LAYER2_STEPS 8                // 3 low quality ~ 16 high quality
#define NL_CLOUD2_LAYER2_SCALE vec2(0.0103, 0.0103) // 0.003 large ~ 0.3 tiny
#define NL_CLOUD2_LAYER2_SHAPE vec2(0.72, 0.72)   // 0.0 round ~ 1.0 box vec2(horizontal shape, vertical shape)
