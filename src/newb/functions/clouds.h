...
float cloudDf(vec3 pos, float rain, vec2 boxiness) {
  ...
  //p0 += mix(4.0, -4.0,2.5);
  p0 += mix(vec2(9.5, -0.4001), vec2(8.8, 0.4001), 3.5);
  p0 += 3.0;
  vec4 r = vec4(rand(p0), rand(p0+vec2(1.0,0.0)), rand(p0+vec2(1.0,1.0)), rand(p0+vec2(0.0,1.0)));
  r = smoothstep(0.3001+0.1*rain, 0.3+0.1*rain*rain, r); // rain transition
...
vec4 renderCloudsRounded(
  ...
  col.rgb = mix(col.rgb, mix((zenithCol + horizonCol), zenithCol,0.95), smoothstep(0.5, 0.0, d.x*d.y));
...
float cloudDf2(vec3 pos, float rain, vec2 boxiness) {
  ...
  p0 += 4.0;
  p0 += mix(vec2(9.0, -0.4001), vec2(8.8, 0.4001), 2.5);
  
  vec4 r = vec4(rand(p0), rand(p0+vec2(1.0,0.0)), rand(p0+vec2(1.0,1.0)), rand(p0+vec2(0.0,1.0)));
  r = smoothstep(0.3501+0.1*rain, 0.35+0.1*rain*rain, r); // rain transition
...
vec4 renderCloudsRounded2(
  ...
  vec2 d = vec2(0.0,0.6);
  for (int i=1; i<=steps; i++) {
    float m = cloudDf2(pos, rain, boxiness);
    d.x += m;
    d.y = mix(d.y, pos.y, m);
    pos += deltaP;
  }
